...
public:
   ...
   void setm(size_t m);
   void setdata(size_t p, size_t n, size_t funcP, size_t intvls, double *x, double *y, size_t nc=100);
   void setdata(size_t p, size_t n, size_t funcP, size_t intvls, double *x, double *y, int* nc);

  // void setdataM(size_t p, size_t n, std::vector<double*>  x_vector, double *y, size_t nc=100, size_t m);


   //void setdataM(size_t p, size_t n, std::vector<double*>  x, double *y, int* nc);
   ...
   void draw(size_t funcP, size_t intvls, double sigma, rn& gen_fp, rn& gen_int, std::vector<double> r_vector);
//   void draw_s(rn& gen);
